Contributing to Gexan
============================

The Gexan project operates an open contributor model where anyone is
...
The following applies to code changes to the Gexan project, and is not to be
confused with overall GEX Network Protocol consensus changes.

Whether a pull request is merged into Gexan rests with the project merge
...
Patches that change GEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the GEX consensus, it must have been
...
The project leader is the release manager for each Gexan release.
