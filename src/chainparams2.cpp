...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
                ( 0,   uint256("0xd0945499aafe5620c4bb1513326d6fcf09549cf66b930e77218adedf1a9f1769") )

;

static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1540218192, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nSwitchPhi2Block = 30000;
        nFirstSCBlock = 30000;
        nPruneAfterHeight = 100000;
        nSplitRewardBlock = 100000;
        ...
        const char* pszTimestamp = "Gexan has invented new technology for lottery"; // Input Activation code to activate blockchain
        CMutableTransaction txNew;
        txNew.nVersion = 1;
        txNew.nTime = 1540218192;
        txNew.nLockTime = 0;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(consensus.hashGenesisBlock == uint256("0xd0945499aafe5620c4bb1513326d6fcf09549cf66b930e77218adedf1a9f1769"));
        assert(genesis.hashMerkleRoot == uint256("0x3f5343da8db5a628d0ca598a106ea5a79a50397b595bf6c0ec6eca902d28c886"));
        ...
        vSeeds.push_back(CDNSSeedData("seed4", "207.138.81.88")); 
        vSeeds.push_back(CDNSSeedData("seed5", "149.38.172.147"));  
...
public:
    CTestNetParams()
    {
        ...
        //consensus.BIP34Height = 227931;
        //consensus.BIP34Hash = uint256S("0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8");
        consensus.powLimit = ~uint256(0) >> 10; // GEX starting difficulty is 1 / 2^12
        consensus.nPowTargetTimespan = 30 * 60; 
        consensus.nPowTargetSpacing = 1 * 60;  
        ...
        const char* pszTimestamp = "Gex - Testnet 1"; // Input Activation code to activate blockchain
        CMutableTransaction txNew;
        txNew.nVersion = 1;
        ...
        assert(consensus.hashGenesisBlock == uint256("0xeeea42130fb17ef1e5bce55caec622691e576471c4092fd5a7c30753fb90e0a5"));
        assert(genesis.hashMerkleRoot == uint256("0x1a111d02741fbc79a4fbd5edd11e44fe922e990c657c3c0aebba67a08886d618"));
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);  
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 155);     
        // Testnet gex BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet gex BIP32 prvkeys start with 'DRKP'
        ...
        strDarksendPoolDummyAddress = "GPGq7DZbqZ8Vb3tfLH8Z8VHqeV4fsK68oX";
...
public:
    CRegTestParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gex: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Gex: 1 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = true;
...
public:
    CSegWitTestnet()
    {
        ...
        consensus.nMajorityRejectBlockOutdated = 950;
        consensus.nMajorityWindow = 1000;
        consensus.powLimit = ~uint256(0) >> 20; // GEX starting difficulty is 1 / 2^12
        consensus.nPowTargetTimespan = 10 * 60; //10 minute
        consensus.nPowTargetSpacing = 60;  // GEX: 1 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        const char* pszTimestamp = "Gex - new great cryptocurrency";
        CMutableTransaction txNew;
        txNew.nVersion = 1;
        ...
        assert(consensus.hashGenesisBlock == uint256("0xcf3bc34742c3f915454b75bad8710624fb2de809e5f59f5950cfa6f03d1206b0"));
        assert(genesis.hashMerkleRoot == uint256("0x2aa0bfd064c819947369d10885cee7460f41f5ae006f4ee976d37ade3c8d2d20"));
