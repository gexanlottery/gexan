...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gex features */
        {"gex", "masternode", &masternode, true, true, false},
        //{"gex", "masternodelist", &masternodelist, true, true, false},
        //{"gex", "mnbudget", &mnbudget, true, true, false},
        //{"gex", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"gex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"gex", "mnsync", &mnsync, true, true, false},
        {"gex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"gex", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> gex-cli " + methodname + " " + args + "\n";
}
