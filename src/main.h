...
/////////////////////////////////////////// gex
#include <gex/gexstate.h>
#include <gex/gexDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <gex/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<GexState> globalState;
...
using ExtractGexTX = std::pair<std::vector<GexTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
#define SNAPSHOT_VALID_TIME  1610064000 /* Friday, 8 January 2021 0.00 GMT */
#endif

#ifndef SNAPSHOT_BLOCK
#define SNAPSHOT_BLOCK 11299500
#endif

#ifndef WORKING_VERSION
#define WORKING_VERSION "/Gexan:2.0.3.2/"
#endif
...
static const int nGexProtocolSwitchHeight = 70;
...
extern unsigned int dgpMaxBlockSize; // gex
...
inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 250 : 60; }
...
class GexTxConverter{

public:

    GexTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionGexTransactions(ExtractGexTX& gexTx);
...
private:
    ...
    GexTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<GexTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
