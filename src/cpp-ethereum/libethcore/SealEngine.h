...
////////////////////////////////////////////////////////////// // gex
	void setGexSchedule(EVMSchedule _gexSchedule) const { gexSchedule = _gexSchedule; }

	EVMSchedule& getGexSchedule() const { return gexSchedule; }
...
private:
	...
	mutable EVMSchedule gexSchedule; // gex
