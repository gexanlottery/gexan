...
#include "genesis/gexMainNetwork.cpp"
#include "genesis/gexTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::gexMainNetwork: return c_genesisInfoGexMainNetwork;
	case Network::gexTestNetwork: return c_genesisInfoGexTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::gexMainNetwork: return c_genesisStateRootGexMainNetwork;
	case Network::gexTestNetwork: return c_genesisStateRootGexTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
