...
bool CWalletDB::WriteGexNodeConfig(std::string sAlias, const CGexNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadGexNodeConfig(std::string sAlias, CGexNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseGexNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
