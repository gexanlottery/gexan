...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GEX);
    unitlist.append(mGEX);
    unitlist.append(uGEX);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GEX:
            return QString("tGEX");
        case mGEX:
            return QString("mtGEX");
        case uGEX:
            return QString::fromUtf8("μtGEX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GEX:
            return QString("GEX");
        case mGEX:
            return QString("Milli-GEX (1 / 1" THIN_SP_UTF8 "000)");
        case uGEX:
            return QString("Micro-GEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GEX:
            return QString("TestGEXs");
        case mGEX:
            return QString("Milli-TestGEX (1 / 1" THIN_SP_UTF8 "000)");
        case uGEX:
            return QString("Micro-TestGEX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
