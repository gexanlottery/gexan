...
QT_MOC_LITERAL(1, 15, 29), // "on_toContractBookStateChanged"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 18) // "on_okButtonClicked"

    },
    "ContractResult\0on_toContractBookStateChanged\0"
    "\0on_okButtonClicked"
};
...
void ContractResult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ContractResult *_t = static_cast<ContractResult *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_toContractBookStateChanged(); break;
        case 1: _t->on_okButtonClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ContractResult::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_ContractResult.data,
      qt_meta_data_ContractResult,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ContractResult::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ContractResult.stringdata0))
        return static_cast<void*>(const_cast< ContractResult*>(this));
