...
QT_MOC_LITERAL(1, 5, 17), // "on_cancel_clicked"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15) // "on_next_clicked"

    },
    "Eula\0on_cancel_clicked\0\0on_next_clicked"
};
...
const QMetaObject Eula::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Eula.data,
      qt_meta_data_Eula,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Eula::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Eula.stringdata0))
        return static_cast<void*>(const_cast< Eula*>(this));
