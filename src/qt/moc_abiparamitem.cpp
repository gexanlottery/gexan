...
void ABIParamItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ABIParamItem::on_addItemClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ABIParamItem::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ABIParamItem::on_removeItemClicked)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ABIParamItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ABIParamItem.data,
      qt_meta_data_ABIParamItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ABIParamItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ABIParamItem.stringdata0))
        return static_cast<void*>(const_cast< ABIParamItem*>(this));
