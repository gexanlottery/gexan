                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    controller = new QtGexUpdater::UpdateController(QStringLiteral("v1.0.0"), this);
    ...
    labelConnectionsIcon->setMaximumSize(25, 25);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
    ...
    LSRTokenAction = new QAction(QIcon(":/icons/lsrtoken"), tr("&GSR Token"), this);
    LSRTokenAction->setStatusTip(tr("GSR Token (send, receive or add Token in list)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gexan"), this);
 ...
 //   checkForUpdateAction = new QAction(QIcon(":/icons/update"), tr("Check for &Update"), this);
   // checkForUpdateAction->setStatusTip(tr("Check whether there is an updated wallet from Gexan"));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled) {
    ...
    tradingAction->setVisible(false);
    QSettings settings;
    if (settings.value("fShowMasternodesTab").toBool()) {
