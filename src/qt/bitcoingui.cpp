...

{
    ...
    resize(1200, 750);
    QString windowTitle = tr("Gexan") + " - ";

#ifdef ENABLE_UPDATER
    controller = new QtGexUpdater::UpdateController(QStringLiteral("v2.0.0"), this);
    ...
    //fill in frameSocMedia
    {
        ...
        pushButtonDiscord->setToolTip(tr("Go to")+" Telegram");
        connect(pushButtonDiscord, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://t.me/gexanlottery"));});
        pushButtonDiscord->setIcon(QIcon(":/icons/res/icons/telegram.png").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));

        pushButtonDiscord = new QPushButton(frameSocMedia);
        pushButtonDiscord->setToolTip(tr("Go to")+" Discord");
        connect(pushButtonDiscord, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://discord.gg/6ndYV3b"));});
        ...
        connect(pushButtonTwitter, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://twitter.com/_gexan_"));});
        ...
        connect(pushButtonGithub, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://github.com/gexanlottery/gexan"));});
        ...
        pushButtonHelp->setToolTip(tr("Go to")+" Gexan web site");
        connect(pushButtonHelp, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://docs.gexanlottery.io/"));});
    ...
    {
        QString url = "https://github.com/GEX-Core/gex/releases";
        QString link = QString("<a href=\\\"\"+ url +\"\\\">\"+ url +\"</a>").arg(NEW_RELEASES, NEW_RELEASES);
        QString message(tr("New gex-qt version available: <br /> %1. <br />").arg(link));
...
void BitcoinGUI::createActions() {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gex: URIs)"));
...
/*
    GSRTokenAction = new QAction(QIcon(":/icons/gsrtoken"), tr("&GSR Token"), this);
    GSRTokenAction->setStatusTip(tr("GSR Token (send, receive or add Token in list)"));
    GSRTokenAction->setToolTip(GSRTokenAction->statusTip());
    GSRTokenAction->setCheckable(true);
#ifdef Q_OS_MAC
    GSRTokenAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_5));
#else
    GSRTokenAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
#endif
    tabGroup->addAction(GSRTokenAction);
*/
    ...
    //connect(GSRTokenAction, SIGNAL(triggered()), this, SLOT(gotoGSRTokenPage()));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GEX"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/gexcoin_black"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verified"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a GEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    openHexAddressAction = new QAction(QIcon(":/icons/editcopy"), tr("&Hex Address Converter"), this);
    openHexAddressAction->setStatusTip(tr("Converter for GEX Smart Contract addresses"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gexan help message to get a list with possible GEX command-line options"));
...
void BitcoinGUI::createToolBars() {
    if (walletFrame) {
        ...
        //toolbar->addAction(GSRTokenAction);
        QSettings settings;
        if (settings.value("fShowMasternodesTab").toBool()) {
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Gexan client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updaterClicked() {
    if (!clientModel)
        return;
#ifdef ENABLE_UPDATER
    controller->start(QtGexUpdater::UpdateController::ProgressLevel);
#else
...
/*
void BitcoinGUI::gotoGSRTokenPage(bool toAddTokenPage)
{
    GSRTokenAction->setChecked(true);
    if (walletFrame) walletFrame->gotoGSRTokenPage(toAddTokenPage);
}
*/
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (clientModel->getNetworkActive())
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gexan network", "", count));
    else
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("Gexan"); // default title
...
void BitcoinGUI::setStakingStatus() {
    ...
    if (stake->HasStaked()) {
        ...
        labelStakingIcon->setToolTip(tr("Staking is active.<br>Network weight is %2.<br>Stake block accepted: %3.<br>MultiSend: %1").arg(fMultiSend ? tr("Active") : tr("Not Active")).arg(GetPoSKernelPS() / COIN).arg(stake->stakeMiner.nBlocksAccepted));
    } else {
        labelStakingIcon->show();
