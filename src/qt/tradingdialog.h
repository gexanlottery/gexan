...
#ifndef GEX_TRADINGDIALOG_H
#define GEX_TRADINGDIALOG_H
...
private slots:
   ...
   // void on_UpdateKeys_clicked(bool Save=true, bool Load=true);
    ...
    void showBalanceOfGEXOnTradingTab();
    ...
    void showBalanceOfGEXOnSendTab();
    void showBalanceOfGEXOnBalanceTab();
   ...
   // void on_BuyBidcomboBox_currentIndexChanged(const QString &arg1);
    ...
    QString BuyGEX(QString OrderType, double Quantity, double Rate);
    QString SellGEX(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"GEX/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"GEX/BTC\"}"));// "{\"gender\":\"male\"}");
