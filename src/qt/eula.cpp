...
void Eula::showDialog()
{
    ...
    QString currentVersion = tr("gex_") + QString::fromStdString(strprintf("%d%d%d%d",
    ...
    if (settings.contains(tr("gexVersion")))
    {
        QString storeVersion = settings.value(tr("gexVersion")).toString();
        ...
        else
        {
            ...
            settings.setValue(tr("gexVersion"), currentVersion);
        }
    }
    else
    {
