...
#include "gex-installer/src/updatecontroller.h"
#endif
...
#ifdef ENABLE_UPDATER
    QtGexUpdater::UpdateController *controller;
#endif
...
private Q_SLOTS:
    ...
    /** Switch to GSRToken page page */
    //void gotoGSRTokenPage(bool toAddTokenPage = false);
