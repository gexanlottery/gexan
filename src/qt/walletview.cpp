// Copyright (c) 2018 The Gexan Developer
                                                                             ...
                                                                             platformStyle(platformStyle)
{
    ...
    GSRTokenPage = new GSRToken(this);
    ...
    connect(overviewPage, &OverviewPage::tokenClicked, GSRTokenPage, &GSRToken::focusToken);
...
void WalletView::setBitcoinGUI(BitcoinGUI* gui)
{
    if (gui) {
        ...
        connect(overviewPage, SIGNAL(addTokenClicked(bool)), gui, SLOT(gotoGSRTokenPage(bool)));
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    GSRTokenPage->setClientModel(clientModel);
    QSettings settings;
    if (settings.value("fShowMasternodesTab").toBool()) {
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    GSRTokenPage->setModel(walletModel);
    QSettings settings;
    if (settings.value("fShowMasternodesTab").toBool()) {
...
void WalletView::gotoGSRTokenPage(bool toAddTokenPage)
{
    setCurrentWidget(GSRTokenPage);
    if(toAddTokenPage)
        GSRTokenPage->on_goToAddTokenPage();
}
