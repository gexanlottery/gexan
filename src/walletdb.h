...
public:
    ...
    bool WriteGexNodeConfig(std::string sAlias, const CGexNodeConfig& nodeConfig);
    bool ReadGexNodeConfig(std::string sAlias, CGexNodeConfig& nodeConfig);
    bool EraseGexNodeConfig(std::string sAlias);
