#!/bin/sh
#-###############################################-#
# C++ Cross-Compiler - The Gexan Developer-2018 #
#-###############################################-#
...
[ -f "./src/qt/gex-qt.exe" ] && cp "./src/qt/gex-qt.exe" "$RELEASE"
[ -f "./src/gexd.exe" ] && cp "./src/gexd.exe" "$RELEASE"
[ -f "./src/gex-cli.exe" ] && cp "./src/gex-cli.exe" "$RELEASE"
