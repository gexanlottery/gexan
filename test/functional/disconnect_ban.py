...
class DisconnectBanTest(GexTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-29, "Node not found in connected nodes", self.nodes[0].disconnectnode, address="69 xxx Street")
