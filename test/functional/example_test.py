...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GexTestFramework
    pass

class ExampleTest(GexTestFramework):
    # Each functional test is a subclass of the GexTestFramework class.
    ...
    def custom_method(self):
        ...
        GexTestFramework class so other tests can use it."""
