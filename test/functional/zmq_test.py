...
from test_framework.test_framework import GexTestFramework, SkipTest
...
class ZMQTest (GexTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gex has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gexd has not been built with zmq enabled.")
