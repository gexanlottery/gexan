...
This means one can have an always-on gexd instance running, and another local gexd/gex-qt instance which connects to this node and receives blocks from it.
