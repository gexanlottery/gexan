...
RESOURCES += src/qt/gex.qrc src/qt/gex_locale.qrc

TRANSLATIONS += src/qt/locale/gex_bg.ts \
                src/qt/locale/gex_de.ts \
                src/qt/locale/gex_en.ts \
                src/qt/locale/gex_es.ts \
                src/qt/locale/gex_fi.ts \
                src/qt/locale/gex_fr.ts \
                src/qt/locale/gex_it.ts \
                src/qt/locale/gex_ja.ts \
                src/qt/locale/gex_pl.ts \
                src/qt/locale/gex_pt.ts \
                src/qt/locale/gex_ru.ts \
                src/qt/locale/gex_sk.ts \
                src/qt/locale/gex_sv.ts \
                src/qt/locale/gex_vi.ts \
                src/qt/locale/gex_zh_CN.ts \
                src/qt/locale/gex_zh_TW.ts
