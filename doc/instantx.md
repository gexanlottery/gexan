...
This mechanism has been integrated into Bitcore-Node-GEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GEX-Project/insight-api-gex#web-socket-api](https://github.com/GEX-Project/insight-api-gex#web-socket-api) 
* API: [https://github.com/GEX-Project/insight-api-gex#instantx-transactions](https://github.com/GEX-Project/insight-api-gex#instantx-transactions)
...
By default, the Gexan daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gexan daemon:
