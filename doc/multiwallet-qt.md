...
In order to support loading of multiple wallets in gex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gex.cpp.
...
Changes to gex.cpp
----------------------
gex.cpp is the entry point into gex-qt, and as such, will require some minor modifications to provide hooks for
