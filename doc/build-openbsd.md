...
This guide describes how to build gexd and command-line utilities on OpenBSD.
...
git clone https://github.com/GEX-Core/gex.git
```
...
(see issue [#6658](https://github.com/GEX-Core/gex/issues/)).
